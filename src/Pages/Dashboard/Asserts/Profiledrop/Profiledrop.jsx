    ...
    return (
        <div>
            <div className="absolute right-0 text-left mt-2 w-48 bg-white rounded-md shadow-lg py-2 z-10">
                ...
                {/* Profile img & id  */}
                <div className='flex justify-center items-center gap-5 px-4 py-2 border-b'>
                    <div className='size-8'>
                        <img src={Profile} alt="Profile" className='rounded-full' />
                    </div>

                    <div>
                        <h1 className='font-semibold'>Lourm name</h1>
                        <p className='text-sm -translate-y-1'>username123</p>
                    </div>
                </div>
                ...
                <div className='border-b'>
                    ...
                    <div href="#username" className="flex gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
